...
if($_SESSION['id_user'] == ''){
  ...
  echo "<script>alert('Gagal Login'); location.href='login_dosen.php'</script>";
                    ...
                    <div class="row">
                        ...
                        if (isset($_POST['simpan']) && $_POST['simpan']) {
                            ...
                            foreach ($_POST['nilai'] as $key => $value) {
                                ...
                                $sql .= "INSERT INTO data_nilai (id_user, id_dosen, id_kriteria, nilai) VALUES ('$nidn', '$id_dosen', '$id_kriteria[$j]', '$value');";
