...
<body>
  <div class="container">
    <div class="card-header ">
      <h3>Form Penilaian Dosen Oleh Mahasiswa</h3>
      ...
      <form action='' method='post'>
        ...
        <table class="table table-hover table-striped" >
          ...
          <tbody>
            <?php
            include "../config/config.php";
            $krDosen = mysqli_query($con, "SELECT * FROM tbl_kriteria WHERE kategori = 2 ");
            $i = 0;
            while ($row = mysqli_fetch_array($krDosen)) {       
              ...
              <tr>
                ...
                <td>
                 ...
                 <label>
                   3 <input type='radio' name="nilai[<?php echo $i; ?>]" value="3"> 
                 </label>
         ...
         <tr>
           <td colspan="3" align="right">
            <input type="submit" name="simpan" value="Simpan Nilai" class="btn btn-info btn-fill btn-sm"> 
          </td>
        </tr>  
      </table>
      <?php 
